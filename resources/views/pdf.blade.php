    ...
    <body>
       <div class="page">
           ...
           <div style="top: 60mm; left: 20mm; position: absolute; color: #1b4b72">
               <div style="display: inline;font-size: 10mm; font-weight: bold;">{{ $data['title'] }}</div>
               <div style="display: inline;font-size: 6mm;font-weight: bold;">{{ $data['subtitle'] }}</div>
           </div>
       </div>
       <div class="page" >
       ...
       <div class="page">
           ...
           <div style="top: 110mm; left: 33mm; position: absolute; font-size: 5mm; color: #1b4b72; font-weight: bold; width: 200cm;">位 置: {{ $ad['position1'] }}</div>
           <div style="top: 120mm; left: 33mm; position: absolute; font-size: 5mm; color: #1b4b72; font-weight: bold; width: 200cm;">点 位: {{ $ad['position2'] }}</div>
           <div style="top: 130mm; left: 33mm; position: absolute; font-size: 5mm; color: #1b4b72; font-weight: bold; width: 200cm;">编 号: {{ $ad['code'] }}</div>
       </div>
       @endforeach
